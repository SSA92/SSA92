...
class DrivingClient(DrivingController):
    ...
    def control_driving(self, car_controls, sensing_info):
        ...
        if prepare_corner(reli_routeInform):
            ...
            if is_corner(sensing_info.track_forward_angles) and sensing_info.speed >= 120:
                theta1 = sensing_info.track_forward_angles[1]
                theta2 = sensing_info.track_forward_angles[2]
