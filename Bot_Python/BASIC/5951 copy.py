...
class DrivingClient(DrivingController):
    ...
    def control_driving(self, car_controls, sensing_info):
        ...
        set_steering = math.degrees(math.atan((X_list[target] - half_load_width * 1.00) / Y_list[target])) - sensing_info.moving_angle 
        ...
        for i in range(0, road_range):
            ...
            if fwd_angle > 40:  ## 커브가 45도 이상인 경우 brake, throttle 을 제어
                # full_throttle = False
                self.is_last_corner = min(self.is_last_corner + 1, 3)
